      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-total-activity">15:05:10</td>
          </tr>
          <tr>
            <td className="wd-full-name text-nowrap">
              <FaUserCircle className="me-2 fs-1 text-secondary" />
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-08-25</td>
          ...
          <tr>
            ...
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-07-30</td>
            <td className="wd-total-activity">14:45:22</td>
          </tr>
        </tbody>
      </table>
    </div>
